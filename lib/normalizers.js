...
export function normalizeQuestion(q) {
  ...
  return {
    ...
    author: { id: q.author_id, name: q.author_name, username: q.author_username, avatar: q.author_avatar, reputation: q.author_reputation },
    tags: q.tags || [],
  };
}
...
export function normalizeAnswer(a) {
  ...
  return {
    ...
    author: { id: a.author_id, name: a.author_name, username: a.author_username, avatar: a.author_avatar, reputation: a.author_reputation },
  };
}
...
export function normalizeDiscussion(d) {
  ...
  return {
    ...
    author: { id: d.author_id, name: d.author_name, username: d.author_username, avatar: d.author_avatar },
  };
}
...
export function normalizeNotification(n) {
  ...
  return {
    ...
    actor: { name: n.actor_name, username: n.actor_username, avatar: n.actor_avatar },
  };
}
